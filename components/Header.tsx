        ...
        <div className="flex items-center gap-8">
          ...
          <nav className="hidden md:flex items-center gap-6">
             ...
             <div className="relative group">
               ...
               <div className="absolute top-full left-0 mt-2 w-48 bg-dark-800 border border-dark-700 rounded shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform translate-y-1 group-hover:translate-y-0">
                  <div className="py-2">
